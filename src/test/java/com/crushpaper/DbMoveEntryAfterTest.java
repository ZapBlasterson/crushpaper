...
/** Tests moving an entry after another entry. */
public class DbMoveEntryAfterTest extends DbLogicTestBase {
	// move node after null node
	@Test
	public void test1() {
	...
	public void test3() {
		...
		final String toMoveId = before.getIdForValue("1");
		final Entry toMoveNode = dbLogic.getEntryById(toMoveId);
		assertFalse(dbLogic.moveEntry(user, toMoveNode, "after",
				false, errors));
	...
	// move node after invalid direction
	@Test
	public void test4() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
				"1",
	...
	// move a node after that has 0 previous and 0 next - fail
	@Test
	public void test5() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
		...
		assertFalse(dbLogic.moveEntry(user, toMoveNode, "after",
				false, errors));
		assertTrue(errors.compare(errorMessages
				.errorThereIsNoEntryToMoveAfter()));
		finalAssertions(user, expectedAfter);
	}

	// move a node after that has 1 previous and 0 next - fail
	@Test
	public void test6() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
				"1",
	...
	// move a node after that has 0 previous and 1 next
	@Test
	public void test7() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
				"1",
		...
		assertTrue(dbLogic.moveEntry(user, toUprootNode, "after",
				false, errors));
		assertFalse(errors.hasErrors());
		finalAssertions(user, expectedAfter);
	}

	// move a node after that has 0 previous and 2 nexts
	@Test
	public void test8() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
	...
	// move a node after that has 1 previous and 1 next
	@Test
	public void test9() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
				"1", new TestEntry[] { new TestEntry("2"), new TestEntry("3"),
	...
	// move a node after that has 1 previous and 2 next
	@Test
	public void test10() {
		final TestEntrySet before = new TestEntrySet(new TestEntry[] { new TestEntry(
				"1", new TestEntry[] { new TestEntry("2"), new TestEntry("3"),
