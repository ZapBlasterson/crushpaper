...
/** Tests importing JSON into the DB. */
public class DbImportTest extends DbLogicTestBase {
	...
	public void test1() {
		...
		final Errors errors = new Errors();
			...
			assertTrue(dbLogic.addEntries(before, user, createTime,
					errors));
			dbLogic.commit();
			assertTrue(dbLogic.importJsonForUser(user.getId(),
	...
	public void test9() {
		...
		final Errors errors = new Errors();
			...
			assertTrue(dbLogic.addEntries(before, user, createTime,
					errors));
			dbLogic.commit();
			assertFalse(dbLogic.importJsonForUser(user.getId(),
					getJsonStreamReader(json), false, false, errors));
	...
	public void test10() {
		...
		final Errors errors = new Errors();
			...
			assertTrue(dbLogic.addEntries(before, user, createTime,
					errors));
			dbLogic.commit();
			assertFalse(dbLogic.importJsonForUser(null,
					getJsonStreamReader(json), false, false, errors));
	...
	public void test11() {
		...
		final Errors errors = new Errors();
			...
			assertTrue(dbLogic.addEntries(before, user, createTime,
					errors));
			dbLogic.commit();
			assertFalse(dbLogic.importJsonForUser(user.getId(), null, false, false,
					errors));
			assertTrue(errors.compare(errorMessages
